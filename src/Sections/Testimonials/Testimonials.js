                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px" >
                    {testimonials.map((t) => (
                        <div
                            ...
                            style={{
                                background: active === t.id ? 'var(--glass-bg)' : 'var(--color-bg)',
                            }}
                        >
                            {/* Quote mark */}
                            <span
                                ...
                                style={{
                                    color: active === t.id ? 'var(--main-var-color)' : 'var(--color-1)',
                            ...
                            {/* Author */}
                            <div className="flex items-center gap-3 pt-2" style={{ borderTop: '1px solid var(--stroke-color)' }}>
                                <div
                                    className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-semibold shrink-0 tracking-wide"
                                    style={{
                                        background: active === t.id ? 'var(--color-1)' : 'var(--glass-bg)',
                                        color: active === t.id ? 'var(--color-3)' : 'var(--color-2)',
                                ...
                                <div>
                                    <p className="text-sm font-medium leading-none mb-1" style={{ color: 'var(--true-color)' }}>
                                        {t.name}
                                    </p>
